...
public class ProfessorController {
    ...
    public String professorHome(Model model) {
        ...
        model.addAttribute("message", "Bienvenue, Professeur !");
        return "professor_home"; // Vue de la page d'accueil du professeur
    }
    ...
    public String getAllResults(Model model) {
        ...
        return "results"; // Vue pour afficher tous les résultats
    }
    ...
    public String showUpdateLessonForm(@PathVariable int id, Model model) {
        ...
        if (existingLesson.isPresent()) {
            ...
            return "professor_update_lesson"; // Vue pour modifier une leçon
        } else {
